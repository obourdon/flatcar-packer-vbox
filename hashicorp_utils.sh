...
CONSUL_VERSION=${CONSUL_VERSION:-1.15.2}
NOMAD_VERSION=${NOMAD_VERSION:-1.5.2}
LOKI_VERSION=${LOKI_VERSION:-2.7.4}
VAULT_VERSION=${VAULT_VERSION:-1.13.0}
CNI_VERSION=${CNI_VERSION:-1.2.0}
